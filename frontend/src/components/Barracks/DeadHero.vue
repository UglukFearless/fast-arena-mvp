<template>
    <div class="dead-hero">
        <img 
            class="dead-hero__skull" 
            src="@/assets/gui/death-skull.svg" />
        <div class="dead-hero__info">
            <img class="dead-hero__portrait" :src="hero.portraitUrl" />
            <div class="dead-hero__props">
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-name">Имя:</span>
                    <span class="dead-hero__props-value">{{ hero.name }}</span>
                </div>
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-name">Уровень:</span>
                    <span class="dead-hero__props-value">{{ hero.level }}</span>
                </div>
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-progress-wrapper">
                        <span 
                            class="dead-hero__props-progress"
                ...
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-name">Здоровье:</span>
                    <span class="dead-hero__props-value">{{ hero.maxHealth }}</span>
                </div>
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-name">Золото:</span>
                    <span class="dead-hero__props-value">{{ heroGold }}</span>
                </div>
                <div class="dead-hero__props-item">
                    <span class="dead-hero__props-name">Побед:</span>
                    <span class="dead-hero__props-value">{{ wins }}</span>
                </div>
            </div>
        </div>
