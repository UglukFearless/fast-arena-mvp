...
- Активные эффекты хранятся в состоянии сессии боя на сервере; ответ каждого раунда возвращает их текущий снимок.
...
- Фаза применения и тип операции эффекта задаются обработчиком и не хранятся в определении эффекта.
...
- Эффекты с `SourceType = Equipment` не попадают в список активных эффектов ответа раунда; влияние экипировки видно по исходу раунда.
